...
public class GetRecommendEventResponse {
    ...
    public static class RunningEvent {
        ...
        protected List<GetRecommendEventResponse.RunningEvent.TravelPlaces> travelPlaces;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GetRecommendEventResponse.RunningEvent.TravelPlaces }
         * 
         * 
         */
        public List<GetRecommendEventResponse.RunningEvent.TravelPlaces> getTravelPlaces() {
            if (travelPlaces == null) {
                travelPlaces = new ArrayList<GetRecommendEventResponse.RunningEvent.TravelPlaces>();
            }
