...
public class GetPlaceResponse {
    ...
    protected List<GetPlaceResponse.TravelPlace> travelPlace;
     ...
     * {@link GetPlaceResponse.TravelPlace }
     * 
     * 
     */
    public List<GetPlaceResponse.TravelPlace> getTravelPlace() {
        if (travelPlace == null) {
            travelPlace = new ArrayList<GetPlaceResponse.TravelPlace>();
        }
