...
@XmlRootElement(name = "getNearByResponse")
public class GetNearByResponse {

    protected List<GetNearByResponse.TravelPlace> travelPlace;
     ...
     * {@link GetNearByResponse.TravelPlace }
     * 
     * 
     */
    public List<GetNearByResponse.TravelPlace> getTravelPlace() {
        if (travelPlace == null) {
            travelPlace = new ArrayList<GetNearByResponse.TravelPlace>();
        }
